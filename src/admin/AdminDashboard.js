...
<div class="bg-card rounded-lg shadow-lg px-6 py-1 border border-customgray mb-6">
      ...
      />
      <button class="text-sm font-medium text-button hover:text-white px-3 py-1 rounded hover:bg-gray-700 transition-colors border border-button focus:outline-none"  onClick={handleAddProduct}>
